...
const (
	BettingService_GetBookies_FullMethodName = "/betting.BettingService/GetBookies"
)
...
type BettingServiceClient interface {
	GetBookies(ctx context.Context, in *GetBookmakersRequest, opts ...grpc.CallOption) (*GetBookmakersResponse, error)
}
...
func (c *bettingServiceClient) GetBookies(ctx context.Context, in *GetBookmakersRequest, opts ...grpc.CallOption) (*GetBookmakersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBookmakersResponse)
	err := c.cc.Invoke(ctx, BettingService_GetBookies_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BettingServiceServer interface {
	GetBookies(context.Context, *GetBookmakersRequest) (*GetBookmakersResponse, error)
...
func (UnimplementedBettingServiceServer) GetBookies(context.Context, *GetBookmakersRequest) (*GetBookmakersResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBookies not implemented")
}
...
func _BettingService_GetBookies_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBookmakersRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BettingServiceServer).GetBookies(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BettingService_GetBookies_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BettingServiceServer).GetBookies(ctx, req.(*GetBookmakersRequest))
	}
...
var BettingService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetBookies",
			Handler:    _BettingService_GetBookies_Handler,
		},
	},
